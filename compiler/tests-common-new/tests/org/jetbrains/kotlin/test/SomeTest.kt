...
@TestMetadata("compiler/tests-common-new/testData")
@TestDataPath("/")
class SomeTest {
    ...
    fun testFirAnalysisA() {
        val path = "compiler/tests-common-new/testData/a.kt"
    ...
    fun testClassicAnalysisA() {
        testRunner(classicAnalysisConfiguration).runTest("compiler/tests-common-new/testData/a.kt")
    }

    private val blackBoxRunnerConfiguration: TestConfigurationBuilder.() -> Unit = {
        globalDefaults {
            frontend = FrontendKinds.ClassicFrontend
            backend = BackendKinds.IrBackend
            targetPlatform = JvmPlatforms.defaultJvmPlatform
    ...
    fun testBBBoxTest() {
        testRunner(blackBoxRunnerConfiguration).runTest("compiler/tests-common-new/testData/boxTest.kt")
    }

    @Test
    @TestMetadata("boxWithRuntimeTest.kt")
    fun testBBBoxWithRuntimeTest() {
        testRunner(blackBoxRunnerConfiguration).runTest("compiler/tests-common-new/testData/boxWithRuntimeTest.kt")
    }

    @Test
    @TestMetadata("boxWithJdkTest.kt")
    fun testBBBoxWithJdkTest() {
        testRunner(blackBoxRunnerConfiguration).runTest("compiler/tests-common-new/testData/boxWithJdkTest.kt")
    }

    @Test
    @TestMetadata("multiModuleBox.kt")
    fun testBBMultiModuleBox() {
        testRunner(blackBoxRunnerConfiguration).runTest("compiler/tests-common-new/testData/multiModuleBox.kt")
    }
    ...
    fun testFirBBBoxTest() {
        testRunner(firBlackBoxRunnerConfiguration).runTest("compiler/tests-common-new/testData/boxTest.kt")
    }

    @Test
    @TestMetadata("boxWithRuntimeTest.kt")
    fun testFirBBBoxWithRuntimeTest() {
        testRunner(firBlackBoxRunnerConfiguration).runTest("compiler/tests-common-new/testData/boxWithRuntimeTest.kt")
    }

    @Test
    @TestMetadata("boxWithJdkTest.kt")
    fun testFirBBBoxWithJdkTest() {
        testRunner(firBlackBoxRunnerConfiguration).runTest("compiler/tests-common-new/testData/boxWithJdkTest.kt")
    }

    @Test
    @TestMetadata("multiModuleBox.kt")
    fun testFirBBMultiModuleBox() {
        testRunner(firBlackBoxRunnerConfiguration).runTest("compiler/tests-common-new/testData/multiModuleBox.kt")
    }
    ...
    fun testJsBBjsTest() {
        testRunner(jsClassicBlackBoxRunnerConfiguration).runTest("compiler/tests-common-new/testData/jsTest.kt")
    }
}
